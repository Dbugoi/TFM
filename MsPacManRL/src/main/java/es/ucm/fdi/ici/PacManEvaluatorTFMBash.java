...
/**
 * PacManEvaluatorTFMBash
 * Class to evaluate the MsPacMans using a bash process
 * It works with algorithmic,fsm,rules,cbr MsPacMans. 
 */
...
import es.ucm.fdi.ici.graficas.GraphicsData;
...
public class PacManEvaluatorTFMBash {
	...
	public static void main(String[] args) {
		...
		if (args.length > 0) {
			...
			PacManEvaluatorTFMBash evaluator = new PacManEvaluatorTFMBash();
	...
	private void getGraphics(EpisodeData e) {
		
		dataLines= new ArrayList<>();
		dataAvg=new ArrayList<>();
		dataCaseBaseSize=new ArrayList<>();
	
		//Resultados luchas
		dataLines=e.getData();
		//Tiempos en cada episodio
		dataTime=e.getAvgTime();
		//Medias knn 
		dataAvg=e.getAvgList();
		//Size of caseBase
		dataCaseBaseSize=e.getCaseBaseSizeList();
	...
	private void getCaseBaseSizeCSV() {
