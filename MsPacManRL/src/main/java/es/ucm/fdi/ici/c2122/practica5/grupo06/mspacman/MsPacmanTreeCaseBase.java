 ...
 */
public class MsPacmanTreeCaseBase implements CBRCaseBase {
	...
	public Collection<CBRCase> getCases(CaseBaseFilter filter) {
		MsPacmanCaseBaseFilter ctFilter = (MsPacmanCaseBaseFilter) filter;
	...
	public void learnCases(Collection<CBRCase> cases) {
		for(CBRCase c: cases) {
			MsPacManDescription res = (MsPacManDescription)c.getDescription();
			if(_workingCases.containsKey(res.getLevel())) {
				int num = (res.getCloseEdible() ? 1 : 0) 
