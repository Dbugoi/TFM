...
import es.ucm.fdi.ici.c2122.practica5.grupo05.mspacman.MsPacManCBRengine;
import es.ucm.fdi.ici.c2122.practica5.grupo05.mspacman.MsPacManInput;
import es.ucm.fdi.ici.c2122.practica5.grupo05.mspacman.MsPacManStorageManager;
...
public class MsPacMan extends PacmanController {
	...
	{		
		...
		this.storageManagerSpecific = new MsPacManStorageManager();
		cbrEngine = new MsPacManCBRengine(storageManager, storageManagerSpecific);
	}
