...
public class Ghosts extends GhostController {
    ...
    public EnumMap<GHOST, MOVE> getMove(Game game, long timeDue) {
        ...
        for (GHOST ghost : GHOST.values()) {
            ...
            if (game.isGhostEdible(ghost)) {
                ...
                // GameViewUtils.addVisualPathFromGhostToMsPacMan(game, ghost, GameViewUtils.getGhostColor(ghost));
            }
    ...
    private MOVE attack(Game game, GHOST ghost) {
        ...
        if (distanceToMsPacman < LIMIT && anyOtherNonEdibleGhostIsInPath(game, shortestPath, ghost))
            return findAlternativePathTowardsMsPacmanWithFewestGhosts(game, ghost);
        else
    ...
    private MOVE findAlternativePathTowardsMsPacmanWithFewestGhosts(Game game, GHOST ghost) {
        int ghostIndex = game.getGhostCurrentNodeIndex(ghost);
