...
public class Retetest {
	...
	public static void main(String args[]) {
		String RULES_PATH = "es"+File.separator+"ucm"+File.separator+"fdi"+File.separator+"ici"+File.separator+"c2122"+File.separator+"practica3"+File.separator+"grupo08"+File.separator;
