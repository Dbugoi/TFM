...
import es.ucm.fdi.ici.c2122.practica5.grupo06.CBRengine.Attribute;
...
public class CustomPlainTextConnector implements Connector {
	...
	public void storeCases(Collection<CBRCase> cases)
	{
		try {
			...
			br = new BufferedWriter(new FileWriter(FileIO.findFile(this.PROP_FILEPATH).getFile(), false)); // LO ERASEAMOS PRIMERO!!!!!!
