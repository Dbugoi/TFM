...
public class EscapeChaseGhostAction implements Action {

	
	public EscapeChaseGhostAction() {
	...
	public MOVE execute(Game game) {
		...
		InfoMiniMax info = InfoMiniMax.minimax(game,  game.getPacmanCurrentNodeIndex(),  MOVE.NEUTRAL,  50, true,Integer.MIN_VALUE, Integer.MAX_VALUE, gc);
	...
	public String getActionId() {
		return "Escape Chase Ghost Action";
	}
