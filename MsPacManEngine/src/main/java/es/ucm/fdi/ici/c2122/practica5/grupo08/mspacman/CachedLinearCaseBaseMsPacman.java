 ...
 */
public class CachedLinearCaseBaseMsPacman implements CBRCaseBase {
	...
	//Listas que separan los casos en fantasmas comestibles o no comestibles
	...
	/**
	 * Devuelve una de las dos listas (Edible o noEdible) dependiendo del filtro por parametro
	 */
	@Override
	public Collection<CBRCase> getCases(CaseBaseFilter filter) {
		// TODO Auto-generated method stub
		MsPacmanCaseFilter filt = (MsPacmanCaseFilter)filter;
