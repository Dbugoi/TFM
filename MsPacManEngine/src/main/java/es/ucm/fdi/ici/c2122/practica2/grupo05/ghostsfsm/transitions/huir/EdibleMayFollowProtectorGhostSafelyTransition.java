...
public class EdibleMayFollowProtectorGhostSafelyTransition implements Transition {
    private final GHOST ghost;

    public EdibleMayFollowProtectorGhostSafelyTransition(GHOST ghost) {
        this.ghost = ghost;
    }
