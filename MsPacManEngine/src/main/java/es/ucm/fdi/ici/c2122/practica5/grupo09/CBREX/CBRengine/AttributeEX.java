...
public class AttributeEX extends es.ucm.fdi.gaia.jcolibri.cbrcore.Attribute {
	...
	public AttributeEX(String attributeName, Class<?> _class) {
	...
	public static void main(String[] args) {
		try {
			AttributeEX a = new AttributeEX("id", MsPacManDescriptionEX.class);
		
			MsPacManDescriptionEX d = new MsPacManDescriptionEX();
			d.setId(25);
